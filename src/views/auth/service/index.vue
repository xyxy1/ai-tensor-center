  ...
  <div>
    <div class="filter-container">
      ...
      <div class="picture-btn-wrap">
        <picture-search ref="pictureSearch" size="mini" style="width: 200px;" placeholder="服务名/服务编码" @change="onSearchChange"></picture-search>
      </div>
      ...
      <el-button size="mini" type="primary" @click="handlerClient">授权服务</el-button>
      <el-button size="mini" type="primary" @click="handlerGenerator">构建工程</el-button>
    </div>
    <!-- 工具栏 -->
    ...
    <el-table :key='tableKey' :data="list" height="calc(100vh - 325px)" v-loading.body="listLoading" @current-change="handleDataCurrentChange" border fit highlight-current-row @selection-change="onListChange">
