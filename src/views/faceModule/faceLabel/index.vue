      ...
      <el-col :span="19" class="right-box">
        ...
        <el-form class="form" ref="listForm" :model="listQuery" :inline="true" @keyup.enter.native="getTableList">
          ...
          <el-form-item prop="name">
            <el-input size="mini" @keyup.enter.native="getTableList" placeholder="姓名/证件号" v-model="listQuery.keyword"></el-input>
          </el-form-item>
          <el-form-item prop="imageCount">
            <el-input size="mini" @keyup.enter.native="getTableList" placeholder="底库数" v-model="listQuery.imageCount"></el-input>
          </el-form-item>
          <el-form-item>
        ...
        <el-table v-show="mode == 0" ref="listTabel" :data="listData.rows" height="calc(100vh - 255px)" v-loading.body="listLoading" highlight-current-row @selection-change="onListChange">
          ...
          <el-table-column width="80" label="证件照">
          ...
          <el-table-column width="60" prop="sex" label="性别"></el-table-column>
          <el-table-column width="60" prop="age" label="年龄"></el-table-column>
          <!-- <el-table-column prop="imgCount" label="底库数"></el-table-column> -->
          <el-table-column prop="accessNames" label="门禁权限"></el-table-column>
        ...
        <el-pagination @size-change="onListLimit" @current-change="onListPaging" :current-page.sync="listQuery.offset" :page-sizes="[100,300,500]" :page-size="listQuery.limit" layout="total, sizes, prev, pager, next, jumper" :total="listData.total"></el-pagination>
      </el-col>
    </el-row>
