<template>
  <div class="dialog-list">
    <el-dialog :title="id?'编辑':'添加'" class="form-layer" :visible.sync="isFormDialog" width="800px">
      ...
      <el-form :model="form" ref="form" :rules="readonly?null:rules" label-width="80px">
        <el-row>
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="24">
                <el-form-item label="类型" prop="labelNums">
                  <el-select v-model="labelSelect" placeholder="请选择" multiple>
              ...
              <el-col :span="24">
                <el-form-item class="accesse-box" label-width="0" prop="labelAccess">
                  ...
                  <div class="right">
                    <div class="accesse-item" v-for="item in form.labelAccess" :key="item.id">{{item.accessName}}</div>
                  </div>
                </el-form-item>
              </el-col>
              <el-col :span="24">
                <el-form-item label="人像库" prop="labelImages">
                  <div class="tip">请上传3～5张清晰正面的人脸照片，每张照片在200k以内</div>
    ...
    <!-- 门牌楼号选择层 -->
    <mlph-form :is-open.sync="isMlphDialog" :data.sync="form.mlph" />
