  ...
  <div class="dangle-after-data">
    ...
    <el-dialog title="尾随详情" class="detail-layer body0" :visible.sync="isDialogDateil" width="1050px">
      ...
      <el-table :data="detailData.records" class="table" height="calc(100vh - 220px)" max-height="600px">
        <el-table-column align="center" label="尾随人" width="80">
          <template slot-scope="scope">
            <img-show width="48px" height="48px" txt="暂无头像" base64 :img-src="scope.row.strangerImgBase" />
          </template>
        </el-table-column>
        ...
        <el-table-column align="center" label="被尾随人" width="80">
          <template slot-scope="scope">
            <img-show width="48px" height="48px" txt="暂无头像" base64 :img-src="scope.row.identityImgBase" />
          </template>
        </el-table-column>
        <el-table-column align="center" label="背景图" width="180">
          <template slot-scope="scope">
            <a @click="onLookPicture(scope.row.identityImgBgUrl)">
              <img-show height="48px" txt="暂无背景" :img-src="scope.row.identityImgBgUrl" class="bg" />
            </a>
          </template>
        </el-table-column>
