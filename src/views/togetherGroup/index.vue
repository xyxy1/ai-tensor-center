<template>
  <div class="app-container">
    ...
    <el-table :data="listTableData.rows" class="table" v-loading="listTableLoading" height="calc(100vh - 255px)">
      ...
      <el-table-column prop="togetherAddr" label="同行地址"></el-table-column>
      <el-table-column prop="togetherTime" label="同行时间"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    // 同行分析提交
    onSubmit() {
      if (this.listQuery.keyword == "" && this.listQuery.image == "") {
        this.$notify({
          title: "提示",
          message: "请输入搜索条件",
          type: "warning",
